 ...
 */
void interface_init(struct bno055_t *bno055) {
	...
	//I2C address is 0x28 (if SDO-pin is gnd) or 0x29 (if SDO-pin is vddio).
	bno055->dev_addr = CONFIG_I2C_ADDR;
	bno055->bus_read = user_i2c_read;
	bno055->bus_write = user_i2c_write;
	bno055->delay_msec = user_delay_ms;
}
